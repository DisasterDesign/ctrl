  ...
  return (
    <section className="py-24 lg:py-32 bg-[#F7F9FB]">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
        <FadeIn>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#142850] mb-4">
            {painPoints.title}
          </h2>
        </FadeIn>
          ...
          {painPoints.items.map((item, index) => (
            <FadeIn key={index} delay={0.3 + index * 0.1}>
              <div className="flex items-center gap-3">
                <span className="text-[#0090D5] font-bold text-lg flex-shrink-0">
                  —
                </span>
        ...
        <FadeIn delay={0.8}>
          <p className="text-lg text-[#666666]">
            {painPoints.closing}
            <br />
            <strong className="text-[#142850] text-xl">
